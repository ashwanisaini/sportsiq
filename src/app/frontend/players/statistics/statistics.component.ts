...
export class StatisticsPlayerComponent {
...
public player_id:any;
	...
	getTeams()
		{
			this._services.getTeamsOfPlayerByPlayerId("users",{"player_id":this.user_id}).subscribe(
              response => {
                this.teams=response;
                this.runJquery();
              },
	...
	// This function is used to get the score of the players of selected team 
	getPlayers(team_id)
		{
			if(team_id!='')
				{					
