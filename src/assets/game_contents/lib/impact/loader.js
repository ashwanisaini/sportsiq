...
ig.Loader = ig.Class.extend({
	...
	draw: function() {
        ...
        ig.system.context.fillStyle = '#1d485c';
        ig.system.context.fillRect( 0, 0, 960, 960 );

        ig.system.context.fillStyle = '#FFFF00';
        ig.system.context.fillRect( x*s, y*s, w*s*this._drawStatus, h*s );

        ig.system.context.fillStyle = '#f00';
        ig.system.context.font = "30px Arial ";
        ig.system.context.fillText("LOADING    "+parseInt(this._drawStatus*100)+" %",280,190);
